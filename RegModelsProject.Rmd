...
Open the data and observe the summary
```{r Loading the data}
...
The are not missing values neither outliers. The data seems to follow a normal distribution. See Appendix 1 for the details.
